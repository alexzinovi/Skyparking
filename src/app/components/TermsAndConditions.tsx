          ...
          {language === "bg" ? (
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              ...
              <section>
                ...
                <p className="text-justify mb-4">
                  5.7. Цените на предлаганите услуги от фирмата "А-Парк 98" ЕООД са обявени на уебсайта на компанията в евро. Плащането се извършва чрез банков превод, плащане с карта или на място с карта или в брой в евро.
                </p>
